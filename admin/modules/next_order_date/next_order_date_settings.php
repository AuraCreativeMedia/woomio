...
<p class="woomio-module-desc">When a user makes an order, the selected date below will act as a reminder to say 'The last time you ordered was X days ago'.</p>

<form method="post" action="" class="woomio-module-form">
